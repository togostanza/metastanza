...
var metastanza = {
  async fetchReq(url, element, post_params) {
    //// url:     API URL
    ...
    const fetchTimeout = function (promise, time) {
      if (!time) {
        time = 600000;
      } // default: 10 min
      return new Promise(function (resolve, reject) {
  ...
  async getFormatedJson(url, element, post_params) {
    const json = await this.fetchReq(url, element, post_params);
  ...
  appendDlButton(buttonDiv, svg, filename, stanza) {
...
//# sourceMappingURL=metastanza_utils-6f306649.js.map
