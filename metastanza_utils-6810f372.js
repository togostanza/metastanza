import { S as Selection, r as root } from './index-b010e6ef.js';
...
function appendDlButton(buttonDiv, svg, filename, stanza) {
  ...
  const downloadImg = function (svg, format, filename, stanza) {
    ...
    console.log('svg.node().outerHTML',svg.node().outerHTML.match(/^([^\>]+\>)/)[1]);
...
//# sourceMappingURL=metastanza_utils-6810f372.js.map
