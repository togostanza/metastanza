...
import { t as toRefs, f as ref, g as computed, o as onMounted, h as onUnmounted, w as watch, c as createBlock, b as openBlock, d as defineComponent, i as onUpdated, j as resolveComponent, k as createVNode, F as Fragment, l as renderList, m as withDirectives, v as vModelText, n as createTextVNode, p as toDisplayString, a as createCommentVNode, r as reactive, q as vModelCheckbox, T as Transition, s as withCtx, e as createApp } from './runtime-dom.esm-bundler-a9a95da9.js';
    ...
    ? (openBlock(), createBlock("div", _hoisted_1, [
        createVNode("div", _hoisted_2, [
          createVNode("div", {
            ...
            createVNode("span", {
              class: "arrow left",
              onClick: _cache[2] || (_cache[2] = $event => (_ctx.currentPage--))
            })
          ], 2 /* CLASS */),
          createVNode("ul", _hoisted_3, [
            (openBlock(true), createBlock(Fragment, null, renderList(_ctx.surroundingPages, (page) => {
              return (openBlock(), createBlock("li", {
                ...
                onClick: $event => (_ctx.currentPage = page)
          ...
          createVNode("div", {
            ...
            createVNode("span", {
              class: "arrow right",
              onClick: _cache[3] || (_cache[3] = $event => (_ctx.currentPage++))
            }),
            createVNode("span", {
              class: "arrow double right",
              onClick: _cache[4] || (_cache[4] = $event => (_ctx.currentPage = _ctx.totalPages))
            })
          ], 2 /* CLASS */),
          createVNode("div", _hoisted_4, [
            _hoisted_5,
            withDirectives(createVNode("input", {
              "onUpdate:modelValue": _cache[5] || (_cache[5] = $event => (_ctx.jumpToNumberInput = $event)),
              type: "text",
              class: "jumpToNumberInput",
              onKeyup: _cache[6] || (_cache[6] = $event => (_ctx.jumpToPage()))
            }, null, 544 /* HYDRATE_EVENTS, NEED_PATCH */), [
              [
                vModelText,
                _ctx.jumpToNumberInput,
                void 0,
                { number: true }
              ]
            ]),
        ...
        (_ctx.isSliderOn === '1' && _ctx.totalPages > 5)
          ? (openBlock(), createBlock(Fragment, { key: 0 }, [
              createVNode("canvas", _hoisted_6, null, 512 /* NEED_PATCH */),
              createVNode(_component_Slider, {
                modelValue: _ctx.currentPage,
                "onUpdate:modelValue": _cache[7] || (_cache[7] = $event => (_ctx.currentPage = $event)),
                min: 1,
                max: _ctx.totalPages,
                class: "pageSlider"
...
const _hoisted_4$1 = /*#__PURE__*/createVNode("img", {
...
const _hoisted_7 = { class: "filterWindowTitle" };
const _hoisted_8 = { class: "toggleAllButton" };
const _hoisted_9 = {
  key: 0,
...
const _hoisted_12 = { class: "rangeInput" };
  ...
  return (openBlock(), createBlock(Fragment, null, [
    createVNode("div", _hoisted_1$1, [
      createVNode("div", _hoisted_2$1, [
        ...
        (_ctx.state.allRows)
          ? (openBlock(), createBlock("table", _hoisted_5$1, [
                ...
                createVNode("tr", null, [
                  ...
                  { active: column.isSearchConditionGiven },
                    ...
                    { lastCol: _ctx.state.columns.length - 1 === i },
                              ...
                              createVNode("p", _hoisted_7, toDisplayString(column.label), 1 /* TEXT */),
                              createVNode("ul", null, [
                                  ...
                                  ? (openBlock(), createBlock("div", _hoisted_11, [
                                      ...
                                      createVNode("div", _hoisted_12, [
                                        withDirectives(createVNode("input", {
                                          ...
                                          type: "text",
                                          class: "min",
                                          onKeyup: $event => (_ctx.setRangeFilters(column))
                                        }, null, 40 /* PROPS, HYDRATE_EVENTS */, ["onUpdate:modelValue", "onKeyup"]), [
                                          [
                                            vModelText,
