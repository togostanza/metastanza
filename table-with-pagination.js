  ...
  return (openBlock(), createBlock(Fragment, null, [
    createVNode("div", _hoisted_1$1, [
      createVNode("form", {
        ...
        onSubmit: _cache[2] || (_cache[2] = withModifiers($event => (_ctx.setQueryInput()), ["prevent"]))
      }, [
        withDirectives(createVNode("input", {
      ...
      ? (openBlock(), createBlock("table", _hoisted_4$1, [
          createVNode("thead", null, [
            createVNode("tr", null, [
              ...
              'icon',
              'filterIcon',
              { isShowing: column === _ctx.state.columnShowingFilters },
              { active: column.filters.some((filter) => !filter.checked) },
                    ...
                    : createCommentVNode("v-if", true),
                  createVNode("span", {
                    class: ['icon', 'searchIcon', { active: _ctx.isSearchOn(column) }],
