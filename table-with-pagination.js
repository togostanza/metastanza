import { c as createCommonjsModule, a as commonjsGlobal, d as defineStanzaElement } from './stanza-element-b0afeab3.js';
...
var script = defineComponent({
  ...
  setup(params) {
    ...
    const rowsInCurrentPage = computed$1(() => {
      const startIndex =
    ...
    const surroundingPages = computed$1(() => {
