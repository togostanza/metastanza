...
/**
 * @param {HTMLElement} self
 * @param {gradationMinColor} string
 * @param {gradationMiddleColor} string
 * @param {gradationMaxColor} string
 * @return {function} カラー生成関数
 */
export function getGradationColor(self, gradationMinColor, gradationMiddleColor, gradationMaxColor) {
  let colors = getColorSeries(self);
  if (gradationMinColor && gradationMaxColor) {
    colors = [gradationMinColor, gradationMaxColor];
    if (gradationMiddleColor) {
      colors = [gradationMinColor, gradationMiddleColor, gradationMaxColor];
    }
  }
