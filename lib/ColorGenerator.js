...
export function getGradationColor(self, colorRange) {
  ...
  // --------------------------------------------------
  // domainとrangeを設定してみる
  // domainはdata / stanza * index
  // domainは dataの数 / 色の数 * index
  ...
  //     (10 / 6) * 5,
  //   ])
  //   .range(["#6590e6", "#3ac9b6", "#9ede2f", "#F5DA64", "#F57F5B", "#E472C6"]);

  // console.log(testColor(0));
  // console.log(testColor(1));
  // console.log(testColor(2));
  // console.log(testColor(3));
  // console.log(testColor(4));
  // console.log(testColor(5));
  // console.log(testColor(6));
