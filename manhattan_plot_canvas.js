...
import { m as metastanza, s as select } from './metastanza_utils-3433d3ff.js';
import { p as pointer, d as drag } from './drag-7cf0b15f.js';
...
async function draw(dataset, stanza, params) {
  ...
  let canvas_div =  select(chart_element).append("div").style("width", areaWidth + "px").style("overflow", "hidden").style("position", "absolute").style("left", marginLeft + "px");
