import { c as createCommonjsModule, d as defineStanzaElement } from './stanza-element-d1cc4290.js';
import { h as has, s as splitAccessPath, $, i as isNumber, a as isString, w as writeConfig, t as toSet, b as isObject, c as isBoolean$1, l as logger, W as Warn, d as isArray, e as isFunction, f as array, m as mergeConfig, g as eventSelector, j as identity, p as parser, V as View, k as parse$1 } from './vega.module-dc1c4886.js';
...
async function barchart(stanza, params) {
  ...
  const view = new View(parse$1(spec), {
    renderer: 'svg',
...
var metadata = {
	...
	{
		"stanza:key": "src-url",
		"stanza:example": "https://db-dev.jpostdb.org/rest/api/metastanza_chart_multi_test?type=instrument",
		"stanza:description": "URL of data source",
		"stanza:required": true
	},
	{
		"stanza:key": "chart-title",
		"stanza:example": "Instrument",
		"stanza:description": "Chart title",
		"stanza:required": false
	},
	{
		"stanza:key": "show-legend",
		"stanza:example": "show-legend",
		"stanza:description": "Whether or not to the legend",
		"stanza:required": true
	}
],
