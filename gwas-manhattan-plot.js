...
const a_dataset$1 = data.a_dataset;
// study name
  ...
  svg
    .on("mousedown", function (e) {
      ...
      if (pointer(e)[1] <= areaHeight) {
        dragBegin = pointer(e)[0]; //dragBeginの値を、イベント発火時のx座標とする
    ...
    .on("mousemove", function (e) {
      if (dragBegin) {
        const dragEnd = pointer(e)[0]; //dragEndをイベント発火時のx座標とする
...
var metadata = {
	...
	"stanza:definition": "manhattan plot(for GWAS) for MetaStanza",
	"stanza:type": "Stanza",
...
var templates = [
  ...
  return "<h1 id=\"manhattan-title\">\n  GWAS Study View\n</h1>\n<h2>\n  "
    ...
    + "\n    </dd>\n    <dt id=\"stage-name\">\n      stage name\n    </dt>\n    <dd>\n      <ul>\n        <li>\n          <input\n            type=\"checkbox\"\n            id=\"discovery\"\n            class=\"stage-btn\"\n            name=\"stage\"\n            value=\"discovery\"\n            data-stage=\"0\"\n          />\n          <label class=\"stage-label\" for=\"discovery\">\n            Discovery\n          </label>\n        </li>\n        <li>\n          <input\n            type=\"checkbox\"\n            id=\"replication\"\n            class=\"stage-btn\"\n            name=\"stage\"\n            value=\"replication\"\n            data-stage=\"1\"\n          />\n          <label class=\"stage-label\" for=\"replication\">\n            Replication\n          </label>\n        </li>\n        <li>\n          <input\n            type=\"checkbox\"\n            id=\"combined\"\n            class=\"stage-btn\"\n            name=\"stage\"\n            value=\"combined\"\n            data-stage=\"2\"\n          />\n          <label class=\"stage-label\" for=\"combined\">\n            Combined\n          </label>\n        </li>\n        <li>\n          <input\n            type=\"checkbox\"\n            id=\"meta-analysis\"\n            class=\"stage-btn\"\n            name=\"stage\"\n            value=\"meta-analysis\"\n            data-stage=\"3\"\n          />\n          <label class=\"stage-label\" for=\"meta-analysis\">\n            Meta-analysis\n          </label>\n        </li>\n      </ul>\n      <button id=\"selectAllBtn\" class=\"allBtn\" type=\"button\" name=\"all\">\n        Select All\n      </button>\n      <button id=\"clearAllBtn\" class=\"allBtn\" type=\"button\" name=\"all\">\n        Clear All\n      </button>\n    </dd>\n  </dl>\n  <ul class=\"condition-list\">\n    <li id=\"condition1\">\n      <span>\n        condition1:\n      </span>\n      &ensp;"
...
["table.html.hbs", {"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n\n<table>\n  <thead>\n    <tr>\n      <th>\n        Gene name\n      </th>\n      <th>\n        rsId\n      </th>\n      <th>\n        Chromosome\n      </th>\n      <th>\n        position\n      </th>\n      <th>\n        Ref\n      </th>\n      <th>\n        Alt\n      </th>\n      <th>\n        P-value\n      </th>\n    </tr>\n  </thead>\n  <tbody>\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"arrays") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams,"loc":{"start":{"line":61,"column":4},"end":{"line":85,"column":13}}})) != null ? stack1 : "")
    + "  </tbody>\n</table>";
